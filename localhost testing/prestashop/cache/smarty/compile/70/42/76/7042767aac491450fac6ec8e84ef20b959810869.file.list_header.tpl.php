<?php /* Smarty version Smarty-3.1.19, created on 2015-03-02 09:49:50
         compiled from "C:\wamp\www\admin2934xmb6d\themes\default\template\controllers\customer_threads\helpers\list\list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:664954f4242e50de24-40515851%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7042767aac491450fac6ec8e84ef20b959810869' => 
    array (
      0 => 'C:\\wamp\\www\\admin2934xmb6d\\themes\\default\\template\\controllers\\customer_threads\\helpers\\list\\list_header.tpl',
      1 => 1420607154,
      2 => 'file',
    ),
    '4a1198f7289e889b448f2d94fa1b99671eb603d5' => 
    array (
      0 => 'C:\\wamp\\www\\admin2934xmb6d\\themes\\default\\template\\helpers\\list\\list_header.tpl',
      1 => 1420607154,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '664954f4242e50de24-40515851',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54f42430ae9200_58317162',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54f42430ae9200_58317162')) {function content_54f42430ae9200_58317162($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'C:\\wamp\\www\\tools\\smarty\\plugins\\function.math.php';
?>
...
<?php }?>
		...
		<div class="col-lg-3">
			<div id="MeaningStatus" class="panel">
				<div class="panel-heading">
					<?php echo smartyTranslate(array('s'=>'Meaning of status'),$_smarty_tpl);?>

				</div>
				<ul class="list-unstyled">
					<li class="text-success"><i class="icon-circle"></i> <?php echo smartyTranslate(array('s'=>'Open'),$_smarty_tpl);?>
</li>
					<li class="text-danger"><i class="icon-circle"></i> <?php echo smartyTranslate(array('s'=>'Closed'),$_smarty_tpl);?>
</li>
					<li class="text-warning"><i class="icon-circle"></i> <?php echo smartyTranslate(array('s'=>'Pending 1'),$_smarty_tpl);?>
</li>
					<li class="text-warning"><i class="icon-circle"></i> <?php echo smartyTranslate(array('s'=>'Pending 2'),$_smarty_tpl);?>
</li>
				</ul>
			</div>
		</div>
...
<?php if (isset($_smarty_tpl->tpl_vars['sql']->value)&&$_smarty_tpl->tpl_vars['sql']->value) {?>
	<form id="sql_form" action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminRequestSql'), ENT_QUOTES, 'UTF-8', true);?>
&amp;addrequest_sql" method="post" class="hide">
		<input type="hidden" id="sql_query" name="sql" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sql']->value, ENT_QUOTES, 'UTF-8', true);?>
" />
