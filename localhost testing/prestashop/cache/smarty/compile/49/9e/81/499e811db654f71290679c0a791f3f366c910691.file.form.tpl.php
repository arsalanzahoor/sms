<?php /* Smarty version Smarty-3.1.19, created on 2015-02-25 06:57:53
         compiled from "C:\wamp\www\admin2934xmb6d\themes\default\template\controllers\request_sql\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2653854ed6461e6eb84-26059374%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '499e811db654f71290679c0a791f3f366c910691' => 
    array (
      0 => 'C:\\wamp\\www\\admin2934xmb6d\\themes\\default\\template\\controllers\\request_sql\\helpers\\form\\form.tpl',
      1 => 1420607154,
      2 => 'file',
    ),
    '05c63a3412c5bdc73890b21b15d3a2c181c44efe' => 
    array (
      0 => 'C:\\wamp\\www\\admin2934xmb6d\\themes\\default\\template\\helpers\\form\\form.tpl',
      1 => 1420607154,
      2 => 'file',
    ),
    '60127a515e73bb44613ed8b4869cf824284d967c' => 
    array (
      0 => 'C:\\wamp\\www\\admin2934xmb6d\\themes\\default\\template\\helpers\\form\\form_group.tpl',
      1 => 1420607154,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2653854ed6461e6eb84-26059374',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54ed6464d359b7_91443027',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ed6464d359b7_91443027')) {function content_54ed6464d359b7_91443027($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'C:\\wamp\\www\\tools\\smarty\\plugins\\function.counter.php';
?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '2653854ed6461e6eb84-26059374');
content_54ed6464161fc6_13361571($_smarty_tpl);
...
<div class="row">
	<div class="col-lg-3">
		<div class="panel">
			<h3><i class="icon-list"></i> <?php echo smartyTranslate(array('s'=>'List of MySQL Tables'),$_smarty_tpl);?>
</h3>
...
"><?php echo $_smarty_tpl->tpl_vars['table']->value;?>
			...
			<div class="form-group">
				<button type="button" id="add_table" class="btn btn-default"><i class="icon-plus-sign"></i> <?php echo smartyTranslate(array('s'=>'Add table name to SQL query'),$_smarty_tpl);?>
</button>
			</div>
		</div>
	</div>
	<div class="col-lg-9">
		<div class="panel">
			<h3><i class="icon-list"></i> <?php echo smartyTranslate(array('s'=>'List of attributes for this MySQL table'),$_smarty_tpl);?>
</h3>
			<div id="listAttributes">
				<div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'Please choose a MySQL table'),$_smarty_tpl);?>
</div>
			</div>
		</div>
	</div>
...
',
				...
				success: function(data){
					var html = "<table class='table'>";
						html += "<thead>";
							html += "<tr>";
								html += "<th><span class=\"title_box\"><?php echo smartyTranslate(array('s'=>'Attribute'),$_smarty_tpl);?>
</span></th>";
								html += "<th class=\"fixed-width-md\"><span class=\"title_box\"><?php echo smartyTranslate(array('s'=>'Type'),$_smarty_tpl);?>
</span></th>";
								html += "<th class=\"fixed-width-md\"><span class=\"title_box\"><?php echo smartyTranslate(array('s'=>'Action'),$_smarty_tpl);?>
</span></th>";
							html += "</tr>";
						html += "</thead>";
						html += "<tbody>";
						for (var i=0; i < data.length; i++)
						{
							html += "<tr>";
								...
								html += "<td><button type=\"button\" class=\"btn btn-default\" onclick=\"javascript:AddRequestSql('"+data[i].Field+"');\"><?php echo smartyTranslate(array('s'=>'Add attribute to SQL query'),$_smarty_tpl);?>
</button></td>";
							html += "</tr>";
						}
						html += "</tbody>";
		...
		$('#add_table').click(function(){
			...
			if (!table)
				jAlert("<?php echo smartyTranslate(array('s'=>'Please choose a table.','js'=>1),$_smarty_tpl);?>
");
			else
				AddRequestSql(table);
		});
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2015-02-25 06:57:56
         compiled from "C:\wamp\www\admin2934xmb6d\themes\default\template\helpers\form\form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_54ed6464161fc6_13361571')) {function content_54ed6464161fc6_13361571($_smarty_tpl) {?>
