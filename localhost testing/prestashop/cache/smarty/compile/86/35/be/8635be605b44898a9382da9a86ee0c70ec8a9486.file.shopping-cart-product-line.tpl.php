<?php /* Smarty version Smarty-3.1.19, created on 2015-03-02 10:10:25
         compiled from "C:\wamp\www\themes\default-bootstrap\shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1835154f4290196cb74-56081448%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8635be605b44898a9382da9a86ee0c70ec8a9486' => 
    array (
      0 => 'C:\\wamp\\www\\themes\\default-bootstrap\\shopping-cart-product-line.tpl',
      1 => 1420607156,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1835154f4290196cb74-56081448',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54f429035f9db2_46803929',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54f429035f9db2_46803929')) {function content_54f429035f9db2_46803929($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\wamp\\www\\tools\\smarty\\plugins\\modifier.replace.php';
...
"><?php echo htmlspecialchars(smarty_modifier_replace($_smarty_tpl->tpl_vars['product']->value['attributes'],Smarty::$_smarty_vars['capture']['sep'],Smarty::$_smarty_vars['capture']['default']), ENT_QUOTES, 'UTF-8', true);?>
	...
	<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value) {?>
		<td class="cart_avail"><span class="<?php if ($_smarty_tpl->tpl_vars['product']->value['quantity_available']<=0&&!$_smarty_tpl->tpl_vars['product']->value['allow_oosp']) {?>label label-warning<?php } else { ?>label label-success<?php }?>"><?php if ($_smarty_tpl->tpl_vars['product']->value['quantity_available']<=0) {?><?php if ($_smarty_tpl->tpl_vars['product']->value['allow_oosp']) {?><?php if (isset($_smarty_tpl->tpl_vars['product']->value['available_later'])&&$_smarty_tpl->tpl_vars['product']->value['available_later']) {?><?php echo $_smarty_tpl->tpl_vars['product']->value['available_later'];?>
...
<?php if (!empty($_smarty_tpl->tpl_vars['product']->value['gift'])) {?>_gift<?php }?>">
			...
			<?php } else { ?>
            	<?php if (!$_smarty_tpl->tpl_vars['priceDisplay']->value) {?>
					<li class="price<?php if (isset($_smarty_tpl->tpl_vars['product']->value['is_discounted'])&&$_smarty_tpl->tpl_vars['product']->value['is_discounted']) {?> special-price<?php }?>"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value['price_wt']),$_smarty_tpl);?>
</li>
				<?php } else { ?>
